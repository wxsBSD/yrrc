// This is just a single testing rule I grabbed from Florian Roth's repo. I've
// added the "sample" metadata and also a "source" link.
rule APT_MAL_DTRACK_Oct19_1 {
   meta:
      source = "https://github.com/Neo23x0/signature-base/blob/master/yara/apt_dtrack.yar"
      ...
      sample = "c5c1ca4382f397481174914b1931e851a9c61f029e6b3eb8a65c9e92ddf7aa4c"
   strings:
